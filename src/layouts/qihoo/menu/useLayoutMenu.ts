...
import { getChildrenMenus, getCurrentParentPath, getMenus, getShallowMenus } from '/@current_project/router/menus';
...
export function useSplitMenu(splitType: Ref<MenuSplitTyeEnum>) {
  ...
  // Menu changes
  watch(
    [() => permissionStore.getLastBuildMenuTime, () => permissionStore.getBackMenuList, () => permissionStore.getActiveMenuItemList],
    () => {
      genMenus();
    },
    {
