...
const ExceptionPage = () => import('/@current_project/views/sys/exception/Exception.vue');
      ...
      children: [
        {
          path: 'basic',
          name: 'FormBasicPage',
          component: () => import('/@current_project/views/demo/page/form/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'step',
          name: 'FormStepPage',
          component: () => import('/@current_project/views/demo/page/form/step/index.vue'),
          meta: {
        ...
        },
        {
          path: 'high',
          name: 'FormHightPage',
          component: () => import('/@current_project/views/demo/page/form/high/index.vue'),
          meta: {
      ...
      children: [
        {
          path: 'basic',
          name: 'DescBasicPage',
          component: () => import('/@current_project/views/demo/page/desc/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'high',
          name: 'DescHighPage',
          component: () => import('/@current_project/views/demo/page/desc/high/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () => import('/@current_project/views/demo/page/result/success/index.vue'),
          meta: {
        ...
        },
        {
          path: 'fail',
          name: 'ResultFailPage',
          component: () => import('/@current_project/views/demo/page/result/fail/index.vue'),
          meta: {
      ...
      children: [
        {
          ...
          component: () => import('/@current_project/views/demo/page/account/center/index.vue'),
          meta: {
        ...
        },
        {
          ...
          component: () => import('/@current_project/views/demo/page/account/setting/index.vue'),
          meta: {
      ...
      children: [
        {
          path: 'basic',
          name: 'ListBasicPage',
          component: () => import('/@current_project/views/demo/page/list/basic/index.vue'),
          meta: {
        ...
        },
        {
          path: 'card',
          name: 'ListCardPage',
          component: () => import('/@current_project/views/demo/page/list/card/index.vue'),
          meta: {
        ...
        },
        {
          path: 'search',
          name: 'ListSearchPage',
          component: () => import('/@current_project/views/demo/page/list/search/index.vue'),
          meta: {
